...
function TopContainer() {
  return (
    <div
      className="w-full h-[300px] relative grid justify-center"
      id="banner"
    >
      <Image
      ...
      <div className=" absolute justify-self-center grid justify-items-center top-[60px]">
        <h1 className="text-white text-4xl p-4 font-bold lg:text-6xl">I&apos;m Startup</h1>
        <p className="text-white px-[20px] text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit</p>
